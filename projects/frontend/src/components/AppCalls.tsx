...
const AppCalls = ({ openModal, setModalState }: AppCallsInterface) => {
  ...
  // Start with null to allow deployment if no app exists
  ...
  // Deploy function for creating new contract instances
        ...
        <div className="flex flex-col gap-4">
          ...
          {!appId && (
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm">Deploy a new Counter contract</p>
            </div>
          )}
          ...
          {appId && (
            <>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm">Interact with the deployed contract</p>
              </div>
            </>
          )}
